# -*- encoding: utf-8 -*-
# stub: bootstrap 5.3.0.alpha3 ruby lib

Gem::Specification.new do |s|
  s.name = "bootstrap".freeze
  s.version = "5.3.0.alpha3"
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<popper_js>.freeze, [">= 2.11.7", "< 3"])
    ...
    s.add_dependency(%q<popper_js>.freeze, [">= 2.11.7", "< 3"])
